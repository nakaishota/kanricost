...
export const monoQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '一応とってあるが、絡まって把握できていない', score: 1 },
      { text: '使う機器の分だけ残して処分する', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '気に入ったものは買い足していく', score: 1 },
      { text: '本当に使うものに絞って持つ', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '切らすのが不安で多めに持つ', score: 1 },
      { text: '予備は1つだけと決めている', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '特別なものは残し、たまに見返す', score: 1 },
      { text: '写真に撮ってから現物は手放す', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'たまに使うものは持っている', score: 1 },
      { text: '汎用の道具で代用できるなら買わない', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '使わないが、しまって保管しておく', score: 1 },
      { text: '気持ちは受け取り、現物は人に譲る', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '気になるものだけ残す', score: 1 },
      { text: 'その場で要不要を判断して捨てる', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '便利そうなら買う', score: 1 },
      { text: '物を減らせば収納はいらないと考える', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '使いそうなものはもらう', score: 1 },
      { text: '今すぐ使うものだけもらう', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '入れ替えのたびに少し迷いつつ残す', score: 1 },
      { text: 'このタイミングで着ないものを手放す', score: 3 },
...
export const digitalQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'そこそこ溜まっているが放置', score: 1 },
      { text: '用が済んだスクショはこまめに消す', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '2〜3個契約している', score: 1 },
      { text: '一番使う1つに絞っている', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '増える一方だが特に整理はしない', score: 1 },
      { text: 'たまに見直して不要な連絡先を消す', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'たまにしか片づけない', score: 1 },
      { text: '使い終わったファイルはすぐ消す', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '読まないものは開かずに溜める', score: 1 },
      { text: '不要と気づいたら配信解除する', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '1〜2個を続けている', score: 1 },
      { text: '飽きたら未練なくアンインストール', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '便利そうなものは取り入れる', score: 1 },
      { text: 'アプリや設定が増えるなら慎重になる', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '気になるものは登録しておく', score: 1 },
      { text: '本当に読む数個に絞っている', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '気に入ったものはもらっておく', score: 1 },
      { text: '実際に使うものだけ入れる', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'なんとなく自動バックアップに任せている', score: 1 },
      { text: '定期的に見直して不要分は消す', score: 3 },
...
export const peopleQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '最低限の付き合いはこなす', score: 1 },
      { text: '当たり障りない範囲でやり過ごす', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '都合がつけば顔を出す', score: 1 },
      { text: '気が向いたときだけ参加', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'ときどき投稿する', score: 1 },
      { text: 'ほとんど投稿しない。見る専門', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '通知が来たら祝うようにしている', score: 1 },
      { text: '親しい数人だけ祝う', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'いくつか所属している', score: 1 },
      { text: '負担にならない範囲で1つだけ', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '断りづらいので合わせて参加する', score: 1 },
      { text: '気が乗らなければ用事を理由に断る', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '少しそわそわするが気にしない', score: 1 },
      { text: '快適。たまにはこういう週末もいい', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '断りづらく、無理してでも出る', score: 1 },
      { text: '親しさ次第で丁重に欠席する', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'ときどきあると楽しい', score: 1 },
      { text: 'たまにで十分。準備や移動は負担', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '気が向いたら連絡する', score: 1 },
      { text: '自然に縁が薄れるのは仕方ないと考える', score: 3 },
...
export const moneyQuestions: Question[] = [
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '余裕があればやる', score: 1 },
      { text: '書類管理が面倒なのでほぼやらない', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '気づいたら維持できている程度', score: 1 },
      { text: 'ランクのために行動を変えることはしない', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'たまにざっと確認する', score: 1 },
      { text: '引き落とし額だけ把握しておく', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'いくつか持って、ときどき見る', score: 1 },
      { text: 'ほったらかしで済む形に絞っている', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'いくつかに残高が散らばっている', score: 1 },
      { text: '使うものを絞り、残高は把握している', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '気が向いたら少し比べる', score: 1 },
      { text: '時間が惜しいのでほどほどで決める', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '紙で来るが、整理はしていない', score: 1 },
      { text: 'ペーパーレスに切り替えている', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '一応とってあるが、どこにあるか曖昧', score: 1 },
      { text: '高額なものだけ残す', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: 'ざっくり分けている', score: 1 },
      { text: '細かく分けず、ゆるく把握する程度', score: 3 },
  ...
  },
  {
    ...
    choices: [
      ...
      { text: '使う頻度を考えつつ、だいたい買う', score: 1 },
      { text: 'たまにしか使わないならレンタルで済ます', score: 3 },
